...
class RuleVariableTests(TestCase):
    ...
    def test_date_variable(self):
        @date_rule_variable()
        def date_variable(): pass

        self.assertTrue(getattr(date_variable, 'is_rule_variable'))
        self.assertEqual(getattr(date_variable, 'field_type'), DateType)
        self.assertEqual(getattr(date_variable, 'label'), 'Date Variable')

    def test_datetime_variable_with_label(self):
        @date_rule_variable(label='Custom Label')
        def date_variable(): pass

        self.assertTrue(getattr(date_variable, 'is_rule_variable'))
        self.assertEqual(getattr(date_variable, 'field_type'), DateType)
        self.assertEqual(getattr(date_variable, 'label'), 'Custom Label')
    ...
    def test_time_variable_with_label(self):
        ...
        self.assertTrue(getattr(time_variable, 'is_rule_variable'))
        self.assertEqual(getattr(time_variable, 'field_type'), TimeType)
        self.assertEqual(getattr(time_variable, 'label'), 'Custom Label')
